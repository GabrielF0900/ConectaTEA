...
import { ListarConexoesPorProfissional } from "../../conexoesDeAmizade/listarConexoesPorProfissional";
...
router.get("/conexoes", authenticated, ListarConexoesPorProfissional);
