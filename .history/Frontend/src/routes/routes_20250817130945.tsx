...
const GestaCriancas = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    idade: '',
    diagnostico: '',
    diagnosticoOutro: '', // Campo para quando selecionar "Outro"
    observacoes: '',
    responsavelEmail: ''
  });
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="sticky top-0 bg-white border-b px-6 py-4 flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Nova Criança</h1>
                <p className="text-gray-600 text-sm">Cadastre uma nova criança no sistema</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <select 
                      ...
                      onChange={(e) => {
                        setFormData({ 
                          ...
                          diagnosticoOutro: e.target.value === 'Outro' ? formData.diagnosticoOutro : ''
                        });
                      }}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                      required
                    >
                      ...
                      <option value="TEA Leve">TEA Leve</option>
                      <option value="TEA Moderado">TEA Moderado</option>
                      <option value="TEA Severo">TEA Severo</option>
                    ...
                    {/* Campo condicional para "Outro" diagnóstico */}
              ...
              <div className="mb-8">
                <h2 className="text-lg font-semibold text-gray-900 mb-4">Informações do Responsável</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="md:col-span-2">
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Nome do Responsável *
