...
import { buscarCriancaPorId, type CriancaListagem } from '../../../api/protected/axiosCadastroCrianca';
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-gray-900 font-medium">
                    {crianca.dataNascimento ? new Date(crianca.dataNascimento).toLocaleDateString('pt-BR') : 'Não informado'}
                  </p>
                </div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-gray-900 font-medium">{crianca.genero || 'Não informado'}</p>
                </div>
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-gray-50 p-4 rounded-lg md:col-span-2">
                  ...
                  <p className="text-gray-900 font-medium">{crianca.responsavel.endereco || 'Não informado'}</p>
                </div>
              </div>
            </div>
