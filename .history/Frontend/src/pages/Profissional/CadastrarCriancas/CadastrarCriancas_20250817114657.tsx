...
// Componente de Cadastro de Crianças - React + TailwindCSS
// Para usar: cole este arquivo no seu projeto (ex.: src/CadastrarCriancas.jsx) e importe no App.jsx
// Requer Tailwind configurado no projeto.
...
const childrenSample = [
  ...
  // adicionar mais itens para testar a listagem
];
