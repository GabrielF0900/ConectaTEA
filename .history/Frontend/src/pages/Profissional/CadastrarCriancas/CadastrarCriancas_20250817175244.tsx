...
export default function CadastrarCriancas() {
  ...
  const [profissional, setProfissional] = useState<ProfissionalInfo>({
    nome: 'Dr. Maria Silva', // Mock - será substituído por dados reais do contexto/API
  ...
  const fetchCriancas = async () => {
    try {
      ...
      const criancasData = response.data.criancas || [];
      ...
      <div className="mb-8">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-2">Gerencie as crianças cadastradas no sistema</p>
          </div>
          <button
      ...
      {isLoading ? (
        ...
        <div className="space-y-4">
          {criancasFiltradas.map((crianca) => (
            <div key={crianca.id} className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <div className="flex justify-between items-start">
                <div className="flex-1 grid grid-cols-1 md:grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      <span className="font-medium">Profissional:</span> Dr. Maria Silva
                    </p>
                  </div>
                  ...
                  <div>
                    <p className="text-sm text-gray-600">
                      <span className="font-medium">Última sessão:</span> 09/01/2024
                    </p>
                  </div>
                </div>
