  ...
  useEffect(() => {
    const fetchCrianca = async () => {
      try {
        ...
        // Calcular data de nascimento baseada na idade (aproximação)
        const currentYear = new Date().getFullYear();
        const birthYear = currentYear - criancaData.idade;
        ...
        setFormData({
          ...
          dataNascimento: approximateBirthDate,
          genero: 'Outro', // Valor padrão, pois não temos gênero na resposta atual
          ...
          endereco: '', // Não temos endereço na resposta atual
          parentesco: 'OUTRO', // Valor padrão, pois não temos parentesco na resposta atual
