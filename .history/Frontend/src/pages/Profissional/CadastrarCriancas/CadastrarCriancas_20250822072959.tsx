...
export default function CadastrarCriancas() {
  ...
  const [erroIdadeNascimento, setErroIdadeNascimento] = useState<string | null>(null);
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    {erroIdadeNascimento && (
                      <div className="md:col-span-3">
                        <span className="text-red-600 text-sm font-semibold">{erroIdadeNascimento}</span>
                      </div>
                    )}
                  </div>
