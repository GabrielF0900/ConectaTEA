...
export default function CadastrarCriancas() {
  ...
  const fetchCriancas = async () => {
    try {
      ...
      let criancasData: CriancaListagem[] = [];
      if (response && response.data && Array.isArray(response.data.criancas)) {
        criancasData = response.data.criancas;
      } else if (response && Array.isArray(response.data)) {
        // Caso a API retorne os dados diretamente no data
        criancasData = response.data as CriancaListagem[];
      } else if (response && Array.isArray(response)) {
        // Caso a API retorne um array diretamente
        criancasData = response as CriancaListagem[];
      } else {
