...
import type { CriancaListagem, CadastroCriancaFormData } from '../../../api/protected/axiosCadastroCrianca';
...
export default function EditarCriancaCadastrada() {
    ...
    const fetchCrianca = async () => {
      try {
        ...
        const mockCrianca: CriancaListagem = {
          ...
          observacoes: 'Criança muito comunicativa, gosta de atividades musicais.',
          responsavelId: 1,
          responsavel: {
            nome: 'Ana Santos',
        ...
        setFormData({
          nomeCompleto: mockCrianca.nome,
          idade: mockCrianca.idade,
          dataNascimento: '2015-03-15', // Mock - calcular baseado na idade
          genero: 'Feminino', // Mock
          diagnostico: mockCrianca.diagnostico,
          diagnosticoOutro: '',
          nomeResponsavel: mockCrianca.responsavel.nome,
          telefone: mockCrianca.responsavel.telefone || '',
          email: mockCrianca.responsavel.email || '',
          endereco: '', // Mock
          parentesco: 'MAE', // Mock
          observacoes: mockCrianca.observacoes || ''
        });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      // TODO: Implementar atualização da criança
      // await atualizarCrianca(id, formData);
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setFormData({ ...formData, parentesco: e.target.value as any })}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
