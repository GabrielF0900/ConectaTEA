  ...
  return (
    <div className="min-h-screen bg-gray-50 px-4 md:px-10 py-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {[
          { valor: 24, label: "Total de Crianças", sub: "+2 este mês" },
          { valor: 8, label: "Profissionais Ativos", sub: "+1 este mês" },
          { valor: 47, label: "Metas Ativas", sub: "+5 esta semana" },
          { valor: "78%", label: "Taxa de Progresso", sub: "+12% este mês" },
        ].map((card, i) => (
          <div key={i} className="bg-white shadow-md rounded-2xl p-6 flex items-center gap-4">
