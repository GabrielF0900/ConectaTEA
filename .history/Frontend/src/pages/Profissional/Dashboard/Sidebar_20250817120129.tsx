  ...
  return (
    <aside className="w-64 bg-white border-r hidden md:flex flex-col">
      ...
      <nav className="flex-1 px-4 py-6 space-y-2">
        <a href="/profissional/dashboard" className="flex items-center px-4 py-2 text-white bg-green-500 rounded-lg font-medium">
          Dashboard
        </a>
        <a href="/profissional/criancas" className="block px-4 py-2 text-gray-600 hover:bg-gray-100 rounded-lg">Crianças</a>
