      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={i} className="bg-white rounded-xl shadow-md border p-5 flex flex-col">
              <div className="flex items-center justify-between mb-3">
                <span className="text-sm text-gray-500">{c.titulo}</span>
                <div className={`w-9 h-9 rounded-full bg-${c.cor}-100 flex items-center justify-center`}>
                  <svg className={`w-5 h-5 text-${c.cor}-600`} fill="currentColor" viewBox="0 0 20 20">
              ...
              {[
                ...
                <div key={i} className="space-y-1">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div className="bg-green-500 h-2 rounded-full transition-all duration-500" style={{ width: `${m.progresso}%` }}></div>
                  </div>
                </div>
              ))}
            </div>
