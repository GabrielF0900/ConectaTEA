    ...
    <div className="min-h-screen bg-gray-50 px-4 md:px-10 py-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {[
          ...
          <div
            key={i}
            className="bg-white shadow-md rounded-2xl p-6 flex items-center gap-4 transition-all duration-200 hover:shadow-lg hover:ring-2 hover:ring-green-200 relative group cursor-pointer hover:-translate-y-2 focus:-translate-y-2"
            style={{ transitionProperty: 'box-shadow, transform, ring', transitionDuration: '200ms' }}
            tabIndex={0}
          >
