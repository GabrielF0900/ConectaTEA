...
function OutlineButton({ icon: Icon, children }: { icon?: any; children: React.ReactNode }) {
  return (
...
function SummaryCard({ icon: Icon, label, value, tooltip }: { icon: any; label: string; value: number | string; tooltip?: string }) {
  return (
