...
function SummaryCard({ icon: Icon, label, value, tooltip }: { icon: React.ElementType; label: string; value: number; tooltip: string }) {
  ...
  <div className="fixed left-1/2 -translate-x-1/2 -top-6 z-[9999] hidden group-hover:flex group-focus:flex flex-col items-center transition-all duration-200 pointer-events-none">
