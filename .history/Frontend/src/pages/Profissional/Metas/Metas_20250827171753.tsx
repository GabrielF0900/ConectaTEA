...
// SVGs dos cards do Dashboard
const metasIcons = [
  // Alvo (Metas)
  <svg width="32" height="32" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="text-green-500"><circle cx="12" cy="12" r="10" strokeWidth="2" /><circle cx="12" cy="12" r="6" strokeWidth="2" /><circle cx="12" cy="12" r="2" strokeWidth="2" /></svg>,
  // Gráfico de linha (Em Andamento)
  <svg width="32" height="32" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="text-green-500"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 12l5 5L20 7" /></svg>,
  // Alerta (Vencendo)
  <svg width="32" height="32" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="text-green-500"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>,
  // Check (Concluídas)
  <svg width="32" height="32" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="text-green-500"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>,
];
      ...
      <div className="mt-6">
        <div className="px-4 md:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <SummaryCard icon={() => metasIcons[0]} label="Total de Metas" value={47} tooltip="Quantidade total de metas cadastradas." />
            <SummaryCard icon={() => metasIcons[1]} label="Em Andamento" value={32} tooltip="Metas que estão em andamento no momento." />
            <SummaryCard icon={() => metasIcons[2]} label="Vencendo" value={8} tooltip="Metas próximas do prazo de vencimento." />
            <SummaryCard icon={() => metasIcons[3]} label="Concluídas" value={15} tooltip="Metas já concluídas." />
          </div>
        </div>
      </div>
