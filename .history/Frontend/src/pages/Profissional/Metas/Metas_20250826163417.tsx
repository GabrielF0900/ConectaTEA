...
function SummaryCard({ icon: Icon, label, value, tooltip }: { icon: React.ElementType; label: string; value: number | string; tooltip?: string }) {
  return (
    <div className="relative rounded-2xl border border-gray-200 bg-white p-8 shadow-md group transition-all flex flex-col items-center justify-center min-w-[210px] min-h-[130px] cursor-pointer hover:shadow-2xl hover:border-green-500 focus-within:shadow-2xl focus-within:border-green-600">
...
export default function MetasPage() {
  ...
  const navigate = (window as any).navigate || (() => {}); // ajuste para navegação, troque por useNavigate se necessário
  return (
