    ...
    <div className="min-h-screen bg-[#f8f9fb]">
      ...
      <div className="max-w-6xl mx-auto px-2 sm:px-0 mt-8">
        <div className="flex gap-2 mb-6">
          ...
          <button className="flex items-center gap-2 px-4 py-2 border border-green-500 rounded-lg bg-white text-green-700 hover:bg-green-50 text-sm font-medium ml-auto">
