              ...
              <div className="mb-3 text-sm">
                <h3 className="font-medium">Redes sociais</h3>
                  <div className="flex gap-3 mt-1">
                    {prof.redes && prof.redes.linkedin && <Linkedin className="w-5 h-5 text-blue-600 cursor-pointer" />}
                    {prof.redes && prof.redes.facebook && <Facebook className="w-5 h-5 text-blue-500 cursor-pointer" />}
                    {prof.redes && prof.redes.instagram && <Instagram className="w-5 h-5 text-pink-500 cursor-pointer" />}
                  </div>
              </div>
