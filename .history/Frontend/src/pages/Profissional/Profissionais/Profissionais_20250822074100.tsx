      ...
      <div className="p-6">
        ...
        <div className="space-y-4">
          {profissionais.map((prof) => (
            <div
              key={prof.id}
              className="bg-white rounded-lg border border-gray-300 shadow-sm p-4 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4"
            >
              ...
              <div className="flex gap-2 self-end sm:self-auto">
                <button className="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                  Ver Perfil
                </button>
                <button className="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                  Editar
