...
const sampleProfissionais: Profissional[] = [
  {
  id: 1,
  usuario_id: 1,
    nome: "Dr. João Santos",
...
export default function Profissionais() {
  ...
  const [profissionais, setProfissionais] = useState<Profissional[]>(sampleProfissionais);
  ...
  function handleAceitar(prof: Profissional) {
    // Lógica para aceitar a solicitação de conexão
    try {
      if (prof.pendente) {
        // Chamar a função para aceitar a solicitação
        await aceitarSolicitacao(prof.usuario_id);
      }
    } catch (error) {
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="text-left">
                  <div className="font-semibold">{profissionais[0]?.nome ?? 'Perfil'}</div>
