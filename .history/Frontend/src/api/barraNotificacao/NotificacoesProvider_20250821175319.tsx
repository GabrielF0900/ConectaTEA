...
interface NotificacoesContextType {
  notificarSucesso: (title: string, message: string, options?: any) => string;
  notificarErro: (title: string, message: string, options?: any) => string;
  notificarAlerta: (title: string, message: string, options?: any) => string;
  notificarInfo: (title: string, message: string, options?: any) => string;
