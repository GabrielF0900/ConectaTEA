        ...
        {profissionais.map((prof) => (
          ...
          >
            <div className="flex-1">
              ...
              <p className="text-gray-600 mt-1">{prof.email}</p>
              <p className="text-gray-600">{prof.telefone}</p>
              <div className="mt-2 text-sm text-gray-700">
                <p>
                  Crianças atendidas:{" "}
                  <span className="font-medium">{prof.criancasAtendidas}</span>
                </p>
                <p>Data de ingresso: {prof.dataIngresso}</p>
                <p className="mt-1">Crianças atuais:</p>
                <div className="flex flex-wrap gap-2 mt-1">
                  {prof.criancas.map((c, i) => (
                    <span
                      key={i}
